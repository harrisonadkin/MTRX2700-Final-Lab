...
void calibrate_gyro(GyroRaw *raw_data, GyroOffsets *offset_data)
{
  ...
  offset_data->x = x_offset;  
  offset_data->y = y_offset; 
  offset_data->z = z_offset; 
...
{
  raw_data->x = raw_data->x + offset_data->x;
  raw_data->y = raw_data->y + offset_data->y;
  raw_data->z = raw_data->z + offset_data->z;
